...
parse_args() {
  ...
  _summary="${opts[summary]:-summary.txt}"
...
update_readme_badges() {
  ...
  # Write initial PR body
  cat << 'INIT_PR_BODY' >&"${fd}"
## Summary

This PR was generated by the badge-updater workflow to keep [README](./README.md) badges in sync with `pnpm-lock.yaml`.
