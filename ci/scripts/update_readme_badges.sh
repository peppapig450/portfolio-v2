...
#   badges in README.md. Uses getopts for CLI parsing and a logging library for
#   structured output and automatic error tracing.
#
# USAGE:
#   Use -l to specify pnpm-lock.yaml, -r to specify README.md.
#   Use -h for help.
#
# REQUIREMENTS:
#   - Bash 4.3+
...
# parse_args <lockfile_var> <readme_var>
...
# update_readme_badges <readme_file> <badge_map_ref> <ver_map_ref>
...
#   $2: badge_map_ref     - Name of associative array mapping badge label->package.
#   $3: ver_map_ref       - Name of associative array variable (pkg->ver).
update_readme_badges() {
  local readme="${1}"
  local -n __badge_map="${2}"
  local -n __ver_map="${3}"
  local tmp
